...
--  Table structure for ``
-- ----------------------------
DROP TABLE IF EXISTS `ph_check_permission`;
CREATE TABLE `ph_check_permission` (
  ...
  `account` tinyint(4) DEFAULT NULL 0 COMMENT'会员账号',
  `name` tinyint(4) DEFAULT NULL 0 COMMENT'会员姓名',
  `agent` tinyint(4) DEFAULT NULL 0 COMMENT'代理商',
  `login_information` tinyint(4) DEFAULT NULL 0 COMMENT '登陆信息',
  `register_date` tinyint(4) DEFAULT NULL 0 COMMENT '注册时间',
   `mobile`tinyint(4) DEFAULT NULL 0 COMMENT '联系电话',
   `email` tinyint(4) DEFAULT NULL 0 COMMENT '邮箱',
   `qq` tinyint(4) DEFAULT NULL 0 COMMENT 'QQ',
   `wechat` tinyint(4) DEFAULT NULL 0 COMMENT '微信',
   `password_hint` tinyint(4) DEFAULT NULL 0 COMMENT '密码提示问题',
   `password_answer` tinyint(4) DEFAULT NULL 0 COMMENT '密码提示答案',
   `withdrawal_password` tinyint(4) DEFAULT NULL 0 COMMENT '取款密码',
   `open_bank` VARCHAR(255) tinyint(4) DEFAULT NULL 0 '开户银行',
   `bank_account` tinyint(4) DEFAULT NULL 0 COMMENT '银行账号',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `ph_check_role`;
CREATE TABLE `ph_check_role` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `create_date` datetime NOT NULL COMMENT '创建日期',
  `modify_date` datetime NOT NULL COMMENT '修改日期',
  `creator` bigint(20) NOT NULL COMMENT '创建人id',
  `modifior` bigint(20) NOT NULL COMMENT '修改人id',
  `version` bigint(20) NOT NULL COMMENT '版本号',
  `admin_id` bigint(20) NOT NULL COMMENT '管理员账号id',
  `ph_check_permission_id` bigint(20) NOT NULL COMMENT '字段权限id',
  `hierarchy` bigint(20) DEFAULT NULL 0 '' COMMENT '分层',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

DROP TABLE IF EXISTS `ph_check`;
CREATE TABLE `ph_check` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  `create_date` datetime NOT NULL COMMENT '创建日期',
  `modify_date` datetime NOT NULL COMMENT '修改日期',
  `creator` bigint(20) NOT NULL COMMENT '创建人id',
  ...
  `login_information` VARCHAR(255) DEFAULT NULL COMMENT '登陆信息',
  `register_date` datetime NOT NULL COMMENT '注册时间',
   `mobile` VARCHAR(255) DEFAULT NULL COMMENT '联系电话',
   `email` VARCHAR(255) DEFAULT NULL COMMENT '邮箱',
   `qq` VARCHAR(255) DEFAULT NULL COMMENT 'QQ',
   `wechat` VARCHAR(255) DEFAULT NULL COMMENT '微信',
   `password_hint` VARCHAR(255) DEFAULT NULL COMMENT '密码提示问题',
   `password_answer` VARCHAR(255) DEFAULT NULL COMMENT '密码提示答案',
   `withdrawal_password` VARCHAR(255) DEFAULT NULL COMMENT '取款密码',
   `open_bank` VARCHAR(255) DEFAULT NULL COMMENT '开户银行',
   `bank_account` VARCHAR(255) DEFAULT NULL COMMENT '银行账号',
   `hierarchy` bigint(20) DEFAULT 0 '分层',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1 DEFAULT CHARSET=utf8 COMMENT='会员查询';
...
-- ----------------------------
BEGIN;
INSERT INTO `ph_admin` VALUES (1,'2017-10-01 20:59:59','2017-10-01 22:08:51',1,1,1,1,0,1,NULL,'2017-10-26 14:24:03',0,'127.0.0.1','17b007bdb8e7af362a1167bcce7277c9','超级管理员','9b16a6a8b524be91d0f440f61ed76fab','superadmin','',0);
INSERT INTO `ph_admin` VALUES (2,'2017-10-13 22:24:06','2017-10-13 22:24:31',1,1,0,1,0,0,NULL,'2017-10-13 22:54:08',0,'127.0.0.1','253da8a9583fccd5645690aa25a71d20','管理员','ec7d8fc2e0093ffec5f39fede8e0bdd6','admin','',0);
...
INSERT INTO `ph_role` VALUES ('3', '2017-10-01 20:59:59', '2017-10-01 20:59:59', 1, 1, '1', 1, '可以查看规定的字段', 0, '客服');
...
CREATE TABLE `ph_admin_role` (
  ...
  CONSTRAINT `fk_admin_role_role_id` FOREIGN KEY (`role_id`) REFERENCES `ph_check_role` (`id`)
...
-- ----------------------------
--  Table structure for `ph_check_role_permission`
-- ----------------------------
DROP TABLE IF EXISTS `ph_check_role_permission`;
CREATE TABLE `ph_check_role_permission` (
  `id` bigint(20) NOT NULL AUTO_INCREMENT COMMENT 'ID',
  ...
  CONSTRAINT `FK_permission_role_role` FOREIGN KEY (`role_id`) REFERENCES `ph_check_role` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
--  Records of `ph_check_role_permission`
-- ----------------------------
BEGIN;

INSERT INTO `ph_check_role_permission` VALUES ('1', '1', '1');
INSERT INTO `ph_check_role_permission` VALUES ('2', '1', '2');
INSERT INTO `ph_check_role_permission` VALUES ('3', '1', '3');
INSERT INTO `ph_check_role_permission` VALUES ('20', '1', '20');
INSERT INTO `ph_check_role_permission` VALUES ('21', '1', '21');
INSERT INTO `ph_check_role_permission` VALUES ('22', '1', '22');
INSERT INTO `ph_check_role_permission` VALUES ('23', '1', '23');
INSERT INTO `ph_check_role_permission` VALUES ('24', '1', '24');
INSERT INTO `ph_check_role_permission` VALUES ('25', '1', '25');
INSERT INTO `ph_check_role_permission` VALUES ('26', '1', '26');
INSERT INTO `ph_check_role_permission` VALUES ('30', '1', '30');
INSERT INTO `ph_check_role_permission` VALUES ('31', '1', '31');
INSERT INTO `ph_check_role_permission` VALUES ('32', '1', '32');
INSERT INTO `ph_check_role_permission` VALUES ('33', '1', '33');
INSERT INTO `ph_check_role_permission` VALUES ('40', '1', '40');
INSERT INTO `ph_check_role_permission` VALUES ('41', '1', '41');
INSERT INTO `ph_check_role_permission` VALUES ('42', '1', '42');
INSERT INTO `ph_check_role_permission` VALUES ('43', '1', '43');
INSERT INTO `ph_check_role_permission` VALUES ('50', '1', '50');
INSERT INTO `ph_check_role_permission` VALUES ('51', '1', '51');
INSERT INTO `ph_check_role_permission` VALUES ('52', '1', '52');
INSERT INTO `ph_check_role_permission` VALUES ('53', '1', '53');
INSERT INTO `ph_check_role_permission` VALUES ('60', '1', '60');
INSERT INTO `ph_check_role_permission` VALUES ('61', '1', '61');
INSERT INTO `ph_check_role_permission` VALUES ('62', '1', '62');
INSERT INTO `ph_check_role_permission` VALUES ('63', '1', '63');
INSERT INTO `ph_check_role_permission` VALUES ('101', '2', '1');
INSERT INTO `ph_check_role_permission` VALUES ('102', '2', '2');
INSERT INTO `ph_check_role_permission` VALUES ('103', '2', '3');
INSERT INTO `ph_check_role_permission` VALUES ('112', '2', '10');
INSERT INTO `ph_check_role_permission` VALUES ('120', '2', '20');
INSERT INTO `ph_check_role_permission` VALUES ('121', '2', '21');
INSERT INTO `ph_check_role_permission` VALUES ('122', '2', '22');
INSERT INTO `ph_check_role_permission` VALUES ('123', '2', '23');
INSERT INTO `ph_check_role_permission` VALUES ('124', '2', '24');
INSERT INTO `ph_check_role_permission` VALUES ('125', '2', '25');
INSERT INTO `ph_check_role_permission` VALUES ('126', '2', '26');
INSERT INTO `ph_check_role_permission` VALUES ('150', '2', '50');
INSERT INTO `ph_check_role_permission` VALUES ('151', '2', '51');
INSERT INTO `ph_check_role_permission` VALUES ('152', '2', '52');
INSERT INTO `ph_check_role_permission` VALUES ('153', '2', '53');
INSERT INTO `ph_check_role_permission` VALUES ('160', '2', '60');
INSERT INTO `ph_check_role_permission` VALUES ('161', '2', '61');
INSERT INTO `ph_check_role_permission` VALUES ('162', '2', '62');
INSERT INTO `ph_check_role_permission` VALUES ('163', '2', '63');
COMMIT;
