...
import (
	...
	"phagego/phage-vip-web/controllers/common/level"
	"phagego/phage-vip-web/controllers/common/lucky"
	"phagego/phage-vip-web/controllers/common/membersingle"
	"phagego/phage-vip-web/controllers/common/membertotal"
	"phagego/phage-vip-web/controllers/common/period"
	"phagego/phage-vip-web/controllers/front"
)
